...
public class PlayerActivity extends AppCompatActivity {
    ...
    TextView txtSName,txtSStart,txtSStop,backBtn;
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        pause_ic=findViewById(R.id.pus_icon_ic);
        ...
        seekMusic=findViewById(R.id.seekbar_id);
...
//                    btnPlay.setBackgroundResource(R.drawable.ic_baseline_play);
                    pause_ic.setImageResource(R.drawable.play_ic);
                    mediaPlayer.pause();
                }else {
//                    btnPlay.setBackgroundResource(R.drawable.ic_baseline_pause);
                    pause_ic.setImageResource(R.drawable.pause_ic);
                    mediaPlayer.start();
                }
            }
        });
